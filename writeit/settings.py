...
LANGUAGES = [
    l
    for l in LANGUAGES
    if os.path.exists(os.path.join(LOCALE_PATHS[0], to_locale(l[0])))
]
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "south-africa-assembly@writeinpublic.pa.org.za"
)
...
SEND_ALL_EMAILS_FROM_DEFAULT_FROM_EMAIL = env.bool(
